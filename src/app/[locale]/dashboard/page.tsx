          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden relative" onClick={e => e.stopPropagation()}>
            ...
            <div className="p-6">
              ...
              {productoModal.categoria === 'Químicos y Limpieza' && (
                <p className="text-xs text-yellow-600 bg-yellow-50 px-3 py-1.5 rounded-lg mb-4">⚠️ Aplica tax de 10.25% en Illinois</p>
              )}
                ...
                return (
                  <div key={p.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 flex flex-col hover:shadow-md transition-shadow overflow-hidden">
                    ...
                    <div className="p-4 flex flex-col flex-1">
                      ...
                      {p.categoria === 'Químicos y Limpieza' && (
                        <p className="text-xs text-yellow-600 mb-2">+10.25% tax</p>
                      )}
                  ...
                  <div className="mt-4 space-y-2 border-t pt-4">
                    ...
                    {taxQuimicos > 0 && (
                      <div className="flex justify-between text-sm text-yellow-600">
                        <span>Tax Químicos y Limpieza (10.25%)</span>
                        <span>${taxQuimicos.toFixed(2)}</span>
                      </div>
                    )}
                    <div className="flex justify-between text-sm text-brand-gray-mid">
