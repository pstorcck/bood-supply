      ...
      <section className="relative min-h-screen flex items-center bg-brand-navy overflow-hidden pt-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 w-full">
          <div className="max-w-3xl">
            <Image src="/logo.png" alt="BOOD SUPPLY" width={180} height={90} className="object-contain mb-8 brightness-0 invert" />
      ...
      <footer id="contacto" className="bg-brand-navy text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            <div>
              <Image src="/logo.png" alt="BOOD SUPPLY" width={140} height={70} className="object-contain mb-4 brightness-0 invert" />
